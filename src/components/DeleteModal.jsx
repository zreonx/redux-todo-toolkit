      ...
      <div className='bg-lightcl dark:bg-slate-600 rounded-md'>
        ...
        <Modal.Footer className='border-none pt-0 mt-0 pb-4 flex items-center justify-end'>
          ...
          <button
            ...
            className='px-4 py-2 border bg-red-400 dark:border-slate-50/50 hover:bg-lightcl dark:text-white rounded-lg dark:hover:bg-gray-500/50 dark:hover:text-white'
          >
            Confirm
          </button>
        </Modal.Footer>
